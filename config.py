...
# 当前: Doubao-Seed-1.8 (更实战的决策)
# 备用: DeepSeek-V3 (ep-m-20260201094201-4465b) | GLM-4.7 (ep-m-20260201094257-n7hkp) | Kimi-K2 (ep-m-20260201095404-b5nhr)
LOGIC_MODEL_PROVIDER = "doubao"
LOGIC_API_KEY = "27ef94bd-bde2-4fbc-b060-57845559b0b4"
LOGIC_ENDPOINT_ID = "ep-m-20260131171948-dlzfs" # Doubao-Seed-1.8
